#!/bin/bash
echo "Installing libs for Goodix fingerprint sensor..."
sudo apt install libfprint-2-tod1
# http://dell.archive.canonical.com/updates/pool/public/libf/libfprint-2-tod1-goodix/
curl -fsSLo /tmp/dell-fingerprint-goodix.deb http://dell.archive.canonical.com/updates/pool/public/libf/libfprint-2-tod1-goodix/libfprint-2-tod1-goodix_0.0.6-0ubuntu1~somerville1_amd64.deb
